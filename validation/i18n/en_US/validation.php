...
(
	...
	'rule_valid_url'     => 'The {name} field must contain a valid URL.',
	'rule_valid_email'   => 'The {name} field must contain a valid email address.',
	'rule_valid_ip'      => 'The {name} field must contain a valid IP address.',
	'rule_valid_type'    => 'The {name} field must only contain {depends_on_field} characters.',
	...
	'rule_length'		 => 'The {name} field must be contain between {min} amd {max} characters.',
